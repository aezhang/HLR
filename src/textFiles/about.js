const aboutText = `<p>Welcome to my  Handwritten Letter Recognizer!<br><br> Just
 ...
 predictions of a Tensorflow model I trained will be displayed. <br> <br> Have fun! </p>`;
